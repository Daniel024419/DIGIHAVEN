...
const ServiceCategory = () => {
  ...
  useEffect(() => {
    try {
      api_connect
        .get("/auth/fetch-services-platform-all")
        .then((response) => {
      ...
      <div>
        <div className="featured-category">
          ...
          <Link
            ...
            className="featured-category-see-all"
            onClick={handleShowAll}
          >
            See All{" "}
            <i className="fas fa-refresh ref-button" title="Refresh Table"></i>
          </Link>
        </div>
