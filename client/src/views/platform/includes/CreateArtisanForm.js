...
const CreateArtisanForm = () => {
  ...
  const handleChange = (event) => {
    ...
    if (event.target.name === "username" && event.target.value.length < 3) {
      ...
      event.target.name === "expertise" &&
      event.target.value.length < 3
    ) {
      error = "Occupation must be at least 3 characters long";
    } else if (
      event.target.name === "work_days_from" &&
      event.target.value.length < 3
    ) {
            ...
            <div className="details personal">
              ...
              <div className="fields">
                ...
                <div className="input-field">
                  ...
                  <div className="input-field-error">
                    {errors.work_days_from && <p>{errors.work_days_from}</p>}{" "}
                    {errors.work_days_end && <p>{errors.work_days_end}</p>}
                  </div>
                </div>
                <div className="input-field">
